...
import { DatePicker, SelectPicker, CustomProvider } from 'rsuite';
...
export function MyRoomsToolbar({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative z-10 mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between",
      )}
    >
      ...
      <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
        {/* Status and Date Filters side-by-side on mobile */}
        {(onStatusFilterChange || onDateFilterChange) && (
        ...
        {/* Search and Create Room side-by-side on mobile */}
        <div className="flex items-center gap-2 w-full sm:w-auto">
          {showSearch ? (
            <div className="group relative flex-1 sm:w-60 sm:flex-initial">
