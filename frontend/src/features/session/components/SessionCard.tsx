...
export function SessionCard({ session, onJoinRoom, onCancel }: SessionCardProps) {
                ...
                <div className="flex flex-col gap-2">
                    {session.status === "upcoming" && (
                        <>
                            ...
                            <button
                                onClick={onCancel}
                                className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-linear-to-r from-red-500 to-rose-600 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-red-500/20 transition-all hover:opacity-90"
                            >
