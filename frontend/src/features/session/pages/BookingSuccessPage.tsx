    ...
    return (
      <div className="w-full max-w-md mx-auto px-4 py-16 text-center">
        <div className="bg-[#121214] border border-zinc-800 rounded-3xl p-8">
          ...
          <p className="text-zinc-400 text-sm mb-6">We couldn't retrieve your booking information. Please check your sessions list.</p>
          <button 
        ...
        >
          ...
          >
            ...
            <button 
              ...
              className="h-14 bg-[#121214] hover:bg-zinc-800 text-white border border-zinc-800 rounded-2xl font-bold text-sm flex items-center justify-center gap-3 transition-all active:scale-[0.98]"
            >
              <Home size={20} />
