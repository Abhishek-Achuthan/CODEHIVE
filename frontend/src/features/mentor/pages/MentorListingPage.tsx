    ...
    return (
        <div className="flex flex-col">
            ...
            {loading ? (
                ...
                <div className="flex min-h-[300px] flex-col items-center justify-center gap-4 rounded-xl border border-dashed border-zinc-800 text-sm text-zinc-500">
                    <p>{error}</p>
                    <button
                        type="button"
                        onClick={retry}
                ...
                >
                    <EmptyState
                        ...
                        description="We couldn't find any mentors matching your criteria. Try adjusting your filters."
                    />
                </motion.div>
            )}
