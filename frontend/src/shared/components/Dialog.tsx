  ...
  return (
    <DialogPortal>
      ...
      >
        {' '}
        {children}{' '}
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground ring-offset-background focus:ring-ring focus:outline-none focus:ring-2 focus:ring-offset-2">
          {' '}
