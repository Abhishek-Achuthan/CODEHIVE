...
import type { BookSessionRequest, SessionPerspective } from "../../shared/types/api/session";
...
export const getBookedSessions = (perspective: SessionPerspective) =>
    apiClient.get(API_ROUTES.SESSION.GET_BOOKED_SESSIONS(perspective));
