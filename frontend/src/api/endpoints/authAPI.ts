...
import type { changePasswordData, ForgotPasswordData, LoginData, OTPData, RegisterData, ResetPasswordData, SetPasswordData } from '../../shared/types/api/auth';
...
export const setPassword = (data:SetPasswordData) => apiClient.patch(API_ROUTES.AUTH.USER_SET_PASSWORD,data)
